    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            if ($count > 0) {
                ...
                $query = mysqli_query($con, "INSERT INTO tblposts (PostTitle,CategoryId,PostDetails,PostUrl,Is_Active,On_Slider,On_Sportlingt,On_Article,On_Gfeed,On_Save,PostImage,repoter,source,subtitle,photocap,seoshort,imageseo,seomkey,PostingDate,UpdationDate) VALUES('$posttitle','$catid','$postdetails','$url','$status','$On_Slider','$On_Sportlingt','$On_Article','$On_Gfeed','$On_Save','$imgnewfile',$reporter,'$source','$subtitle','$photocap','$seoshort','$imageseo','$seomkey','$date','$date')");
