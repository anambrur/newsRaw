                                        ...
                                        <div class="p-6">
                                            <div class="">
                                                ...
                                                <?php } ?>
                                                 ...
                                                 <input type="text" class="form-control" id="name" name="AdminUserName" value="<?php echo @$edit['AdminUserName'] ?>" required>
                                                 </div>

                                          <div class="form-group m-b-20">
                                            <p style="font-size:18px">Password</p>
                                            <input type="password" class="form-control" id="url" name="AdminPassword" value="">
                                         </div>
                                         <div class="form-group m-b-20">
                                            <p style="font-size:18px">Email</p>
                                            <input type="text" class="form-control" id="url" name="AdminEmailId" value="<?php echo @$edit['AdminEmailId'] ?>" required>
                                         </div>
                                         <div class="form-group m-b-20">
                                            ...
                                            <select class="form-control" name="role">
                                                ...
                                                <option value="editor" <?php if(@$edit['role']=='editor'){ echo "selected";} ?>>Editor</option>
                                            </select>
                                         </div>
