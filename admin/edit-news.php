                ...
                <div class="page-header">
                    <div class="page-block card mb-0">
                        <div class="card-body">
                            ...
                            <?php
                            $postid = intval($_GET['pid']);
                            $query = mysqli_query($con, "select tblposts.id as postid,tblposts.PostImage, tblposts.On_Slider,tblposts.PostingDate,tblposts.UpdationDate, tblposts.ScheduledPublish, tblposts.On_Sportlingt, tblposts.On_Article, tblposts.On_Gfeed, tblposts.On_Save, tblposts.PostTitle as title,tblposts.PostDetails,tblcategory.CategoryName as category,tblcategory.id as catid,tblsubcategory.SubCategoryId as subcatid,tblsubcategory.Subcategory as subcategory,tblposts.repoter,tblposts.source,tblposts.subtitle,tblposts.photocap,tblposts.seoshort,tblposts.imageseo,tblposts.seomkey from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join tblsubcategory on tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.id='$postid'");
