                                   ...
                                   <div class="row">
                                        <div class="col-sm-8 text-left">
                                             <div class="DescTitle">
                                                  ...
                                                  <h2>
                                                       <?php
                                                       if ($row['staticReporterName'] == null || $row['staticReporterName'] == '') {
                                        ...
                                        <div class="col-sm-4">
                                             <div class="DSocialTop">
                                                  <div class="addthis_inline_share_toolbox_27te"></div>
                                             </div>
                                        </div>
                                   </div>
                              </div>
