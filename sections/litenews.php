                                        ...
                                        <a href="news-details?nid=<?php echo $row['id']; ?>">
                                             <div class="Imgresize">
                                                  <figure class="ImgViewer">
                                                       <picture class="FixingRatio"><img src="admin/images/postimages/<?php echo $row['PostImage']; ?>" alt="<?php echo $row['PostTitle']; ?>" title="<?php echo $row['PostTitle']; ?>" class="img-fluid img100 ImgRatio"></picture>
                                                  </figure>
                                             </div>
                                             <div class="Desc">
                                   ...
                                   ?>
                                        <div class="DLeadNewsList">
                                             <a href="news-details?nid=<?php echo $row['id']; ?>">
                                                  <div class="Imgresize">
                                                       <figure class="ImgViewer">
                                                            <picture class="FixingRatio"><img src="admin/images/thumb/<?php echo $row['PostImage']; ?>" alt="<?php echo $row['PostTitle']; ?>" title="<?php echo $row['PostTitle']; ?>" class="img-fluid img100 ImgRatio"></picture>
                                                       </figure>
                                                  </div>
                                                  <div class="Desc">
                                                       <h2 class="Title TitleBold"><?php echo $row['PostTitle']; ?></h2>
                                                  </div>
                                             </a>
                                        </div>
                                   <?php } ?>
                                        ...
                                        <a href="news-details?nid=<?php echo $row['id']; ?>">
                                             <div class="row">
                                                  <div class="col-lg-12 col-sm-3 col-5">
                                                       <div class="Imgresize">
                                                            <figure class="ImgViewer">
                                                                 <picture class="FixingRatio"><img data-src="admin/images/thumb/<?php echo $row['PostImage']; ?>" src="images/site/no-img.png" alt="<?php echo $row['PostTitle']; ?>" title="<?php echo $row['PostTitle']; ?>" class="img-fluid img100 Ratio Ratio16x9 ImgRatio"></picture>
                                                            </figure>
                                                       </div>
                                                  </div>
...
?>" class="container">
          <div style="background-color:#<?php echo $back_color; ?>" class="SPSecTitle">
               <a href="category.php?catid=10">
                    <h2 style="font-size:30px; text-align:center">
                         ...
                         <class="TitleIcon"> <?php echo $live; ?> <i class="fa fa-arrow-left" aria-hidden="true"></i>
                    </h2>
               </a>
          </div>
          ...
          <div class="row">
               ...
               <div class="col-lg-6 col-sm-12 border-right-inner1">
                    <a href="category.php?catid=2">
                         <h2>
                              <div class="SecTitle mt-0 mb-3">
                                   <h2><i class="fa fa-newspaper" aria-hidden="true"></i> মহানগর</h2>
                              </div>
                    </a>
                    <div class="row">
                         <?php
               ...
               <div class="col-lg-6 col-sm-12 border-right-inner1">
                    <a href="category.php?catid=3">
                         <h2>
                              <div class="SecTitle mt-0 mb-3">
                                   <h2><i class="fa fa-newspaper" aria-hidden="true"></i> জাতীয়</h2>
                              </div>
                    </a>
                    <div class="row">
                         <?php
               ...
               <div class="row">
                    ...
                    <div class="col-lg-12 col-12 border-right-inner1">
                         <a href="category.php?catid=4">
                              <h2>
                                   <div class="SecTitle mt-0 mb-3">
                                        <h2><i class="fa fa-newspaper" aria-hidden="true"></i> রাজনীতি</h2>
                                   </div>
                                   </aa>
                                   <div class="row">
     ...
     <div style="display:none" class="VideoGalleryBG">
          <div class="container">
               <div class="SPSecTitle2">
                    <a href="#">
                         <h2><i class="fa fa-newspaper" aria-hidden="true"></i> ভিডিও গ্যালারি</h2>
                    </a>
               </div>
                                   ...
                                   <a href="news-details?nid=<?php echo $row['id']; ?>">
                                        <div class="row">
                                             <div class="col-lg-12 col-sm-12 col-12">
                                                  <div class="Imgresize">
                                                       <figure class="ImgViewer">
                                                            <picture class="FixingRatio"><img data-src="admin/images/thumb/<?php echo $row['PostImage']; ?>" src="images/site/no-img.png" alt="<?php echo $row['PostTitle']; ?>" title="<?php echo $row['PostTitle']; ?>" class="img-fluid img100 ImgRatio"></picture>
                                                       </figure>
                                                  </div>
                                             </div>
               ...
               <div class="col-lg-3 col-sm-12">
                    <div class="SecTitle mt-0">
                         <a href="category.php?catid=11">
                              <h2> <i class="fa fa-newspaper" aria-hidden="true"></i> প্রবাস </h2>
                         </a>
                    </div>
               ...
               <div class="col-lg-3 col-sm-12">
                    <div class="SecTitle mt-0">
                         <a href="category.php?catid=8">
                              <h2><i class="fa fa-newspaper" aria-hidden="true"></i> অর্থনীতি</h2>
                         </a>
                    </div>
               ...
               <div class="col-lg-3 col-sm-12">
                    <div class="SecTitle mt-0">
                         <a href="category.php?catid=21">
                              <h2><i class="fa fa-newspaper" aria-hidden="true"></i> মুক্তমত</h2>
                         </a>
                    </div>
     ...
     <div class="container">
          <div class="row MT30">
               ...
               <div class="col-lg-3 col-sm-12">
                    <div class="SecTitle mt-0">
                         <a href="category.php?catid=7">
                              <h2><i class="fa fa-newspaper" aria-hidden="true"></i> সম্পাদকীয়</h2>
                         </a>
                    </div>
               ...
               <div class="col-lg-3 col-sm-12">
                    <div class="SecTitle mt-0">
                         <a href="category.php?catid=20">
                              <h2><i class="fa fa-newspaper" aria-hidden="true"></i> স্বাস্থ্য</h2>
                         </a>
                    </div>
               ...
               <div class="col-lg-3 col-sm-12">
                    <div class="SecTitle mt-0">
                         <a href="category.php?catid=19">
                              <h2><i class="fa fa-newspaper" aria-hidden="true"></i> সাহিত্য</h2>
                         </a>
                    </div>
     ...
     <div style="background-color:#1d3649; padding-top:10px; padding-bottom:15px" class="container">
          <div class="SPSecTitle">
               <a href="category.php?catid=9">
                    <h2 style="color:#fff"> <i class="fa fa-arrow-right" aria-hidden="true"></i>
                         <class="TitleIcon">বিনোদন
                    </h2>
               </a>
          </div>
                         ...
                         ?>
                              <div class="DEntertainmentTop">
                                   <a href="news-details?nid=<?php echo $row['id']; ?>">
                                        <div class="Imgresize">
                                             <figure class="ImgViewer">
                                                  <picture class="FixingRatio"><img data-src="admin/images/postimages/<?php echo $row['PostImage']; ?>" src="images/site/no-img.png" alt="<?php echo $row['PostTitle']; ?>" title="<?php echo $row['PostTitle']; ?>" class="img-fluid img100 ImgRatio"></picture>
                                             </figure>
                                        </div>
                                        <div class="Desc">
...
<div class="container">
     <div class="row MT30">
          ...
          <div class="col-lg-3 col-sm-12">
               <div class="SecTitle mt-0">
                    <a href="category.php?catid=18">
                         <h2><i class="fa fa-newspaper" aria-hidden="true"></i> শিক্ষাঙ্গন</h2>
                    </a>
               </div>
          ...
          <div class="col-lg-3 col-sm-12">
               <div class="SecTitle mt-0">
                    <a href="category.php?catid=16">
                         <h2><i class="fa fa-newspaper" aria-hidden="true"></i> ধর্ম ও জীবন</h2>
                    </a>
               </div>
          ...
          <div class="col-lg-3 col-sm-12">
               <div class="SecTitle mt-0">
                    <a href="category.php?catid=17">
                         <h2><i class="fa fa-newspaper" aria-hidden="true"></i> বিচিত্র সংবাদ </h2>
                    </a>
               </div>
